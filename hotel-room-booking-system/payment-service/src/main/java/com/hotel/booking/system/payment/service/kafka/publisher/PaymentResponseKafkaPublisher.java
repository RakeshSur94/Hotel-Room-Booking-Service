package com.hotel.booking.system.payment.service.kafka.publisher;
...
public class PaymentResponseKafkaPublisher {
    ...
    public void publishPaymentResponseTopicToBookings(BookingDTO bookingDTO){
        log.info("Publishing  booking details to PaymentResponse Topic");
